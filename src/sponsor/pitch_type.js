...
// var training = require('./pitch_type_training_data.csv')
...
const TRAIN_DATA_PATH = require('./pitch_type_training_data.csv');
console.log("something 2")
const TEST_DATA_PATH =    require('./pitch_type_test_data.csv');
